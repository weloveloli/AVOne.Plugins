...
namespace AVOne.Plugins.NM3U8DL.Providers
{
    ...
    public class NM3U8DLREDownloader : IDownloaderProvider
    {
        private readonly IApplicationPaths _applicationPaths;
        private readonly IStartupOptions _options;

        public NM3U8DLREDownloader(IApplicationPaths applicationPaths, IStartupOptions options)
        {
